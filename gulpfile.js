...
const srcJS = [asset_path + "jquery-3.7.1.min.js", asset_path + "gsap.min.js", asset_path + "ScrollTrigger.min.js", asset_path + "SplitType.min.js", asset_path + "lottie.min.js", asset_path + "ScrollLottie.js"]
...
gulp.task("copy-3d", function () {
	return gulp.src("src/assets/3d/**/*.*").pipe(gulp.dest("./public/assets/3d/"))
})

// Copy Sound
gulp.task("copy-sound", function () {
	return gulp.src("src/assets/sound/**/*.*").pipe(gulp.dest("./public/assets/sound/"))
})
...
gulp.task("copy-modal", function () {
	return gulp.src("src/modal/**/*.*").pipe(gulp.dest("./public/modal/"))
})

// Build Complete Public Folder
// gulp.task('default', gulp.series('html','copy-src-js','copy-actions','pack-js','copy-img','copy-font','scss'));
gulp.task("default", gulp.series("html", "copy-src-js", "pack-js", "copy-sound", "copy-vid", "copy-3d", "copy-img", "copy-font", "scss", "purgecss"))
...
gulp.task("watch", function () {
	...
	gulp.watch("src/assets/3d/**/*.*", gulp.series("copy-3d"))
